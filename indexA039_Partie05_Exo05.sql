...
Exercice 05 - Partie V
Tables utilisées :
lpecom_covid
lpecom_regions
*/

-- Quelle requête SQL utiliser pour afficher le nombre au cumulé de vaccination première dose 
-- pour la région avec le code 93 uniquement pour le mois de mars 2021 
SELECT 
    SUM(n_dose2)
FROM
    lpecom_covid
WHERE
    MONTH(jour) = 3 AND id_region = 11